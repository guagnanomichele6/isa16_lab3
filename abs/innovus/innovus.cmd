...
set init_top_cell RISCV_pipeline_abs
set init_verilog ../netlist/RISCV_pipeline_abs.v
...
saveDesign RISCV_pipeline_abs.enc
getDrawView
setDrawView fplan
win
...
timeDesign -postRoute -pathReports -drvReports -slackReports -numPaths 50 -prefix RISCV_pipeline_abs_postRoute -outDir timingReports
redirect -quiet {set honorDomain [getAnalysisMode -honorClockDomains]} > /dev/null
timeDesign -postRoute -hold -pathReports -slackReports -numPaths 50 -prefix RISCV_pipeline_abs_postRoute -outDir timingReports
...
reportGateCount -level 5 -limit 100 -outfile RISCV_pipeline_abs.gateCount
saveNetlist RISCV_pipeline_abs.v
...
report_power -rail_analysis_format VS -outfile .//RISCV_pipeline_abs.rpt
